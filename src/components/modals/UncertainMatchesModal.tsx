        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-6">
          {matches.length === 0 ? (
            ...
            matches.map((match, i) => {
              ...
              return (
                <div key={i} className="bg-white/10 p-4 rounded-xl border border-white/20 flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex flex-col justify-center gap-2">
                    <button 
                      ...
                      className="flex items-center justify-center gap-2 bg-white/30 text-white px-6 py-3 rounded-xl font-medium hover:bg-white/40 transition-all active:scale-95"
                    >
                      <CheckCircle className="w-4 h-4" /> Bestätigen
                    </button>
                    <button 
                      onClick={() => onRejectMatch(match)}
                      className="flex items-center justify-center gap-2 bg-white/30 text-white px-6 py-3 rounded-xl font-medium hover:bg-white/40 transition-all"
                    >
